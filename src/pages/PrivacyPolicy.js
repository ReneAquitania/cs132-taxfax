...
const PrivacyPolicy = () => {
  return (
    <div className="p-10">
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Tax Fax.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Tax Fax, accessible from <a href="https://reneaquitania.github.io/cs132-taxfax/" rel="external nofollow noopener" target="_blank">https://reneaquitania.github.io/cs132-taxfax/</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>By email: cs132taxfax@gmail.com</li>
        </ul>
    </div>
  )
}
