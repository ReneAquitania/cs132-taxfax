    ...
    <div className="mt-10 flex min-w-full justify-center">
      <div className="md:w-3/5">
        ...
        <div className="mt-10 space-y-3 px-8 py-3 border-[5px] border-taxfaxred-300 rounded-3xl">
          ...
          <p>Due to the number of unique words found among the tweets (945), the plot is cannot show all the unique words due to spatial constraints. Instead, we will show the top 10 most frequent words that were used. </p>
        ...
        <div className="mt-10 space-y-3 px-8 py-3 border-[5px] border-taxfaxblue-300 rounded-3xl">
          ...
          <div className="mt-10 space-y-3 px-8 py-3 border-[5px] border-taxfaxred-300 rounded-3xl">
            <h1 className="text-3xl font-bold">Plot 4: Dates Posted Distribution</h1>
